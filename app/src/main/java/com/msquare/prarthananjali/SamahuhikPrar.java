...
public class SamahuhikPrar extends AppCompatActivity {
    ...
    private void initData2() {
        ...
        versionsList = new ArrayList<>();
        versionsList.add(new Versions("6.1 दिवसाप्रमाणे पवित्र शास्त्रामधून वाचन", " ", " ", "a "));

        versionsList.add(new Versions("6.2 प्रसंगानुसार पवित्र शास्त्र वाचन", " ", " ", "a "));

        versionsList.add(new Versions("6.3 दिवंसा प्रमाणे प्रार्थना", " ", " ", "a "));

        versionsList.add(new Versions("6.4 कौटुंबिक/सामूहिक प्रार्थनेचे वेगवेगळे पद्धत", " ", " ", "a "));

        versionsList.add(new Versions("6.5 येशूच्या अति पवित्र हृदयाची नवमी", " ", " ", "a "));

        versionsList.add(new Versions("6.6 येशूची विनंतीमाला", " ", " ", "a "));

        versionsList.add(new Versions("6.7  ख्रिस्त राजाला प्रार्थना", " ", " ", "a "));

        versionsList.add(new Versions("6.8 येशूच्या हृयास कुटुंबाचे समर्पण", " ", " ", "a "));

        versionsList.add(new Versions("6.9 ख्रिस्तशरीर संस्कारासमोर प्रार्थना", " ", " ", "a "));

        versionsList.add(new Versions("6.10 पवित्र आत्म्याची प्रार्थना", " ", " ", "a "));

        versionsList.add(new Versions("6.11 पाचारणासाठी प्रार्थना", " ", " ", "a "));

        versionsList.add(new Versions("6.12 सुवार्ता आदान-प्रदान विधी (लहान ख्रिस्तीय समूहाचा सात पदाची प्रार्थना)", " ", " ", "a "));

        versionsList.add(new Versions("6.13 धन्याष्टक (मत्तय; ५: ३-१०)", " ", " ", "a "));
